...
<head>
  <title>PHARMACIE &mdash; Online Pharmacy Automation System</title>
  <meta charset="utf-8">
  ...
  <style>
    .owl-carousel .site-blocks-cover {
      height: 100vh;
...
<body>
  <!-- <div class="site-wrap"> -->
    ...
    <div class="site-navbar py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-left justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a class="js-logo-clone"><strong class="text-primary"> Pharma</strong>cie</a>
            </div>
          </div>
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <!-- <li><a href="./Guest/Login.php" class="btn btn-warning">LOGIN</a></li> -->
                ...
                <li class="has-children">
                  ...
                  <a href="#">PHARMACIST</a>
                  <ul class="dropdown">
                    <li><a href="./Pharmacist/AddUser.php">Add User</a></li>
                    <li class="has-children">
                      <a href="#">Profile</a>
                      <ul class="dropdown">
                      <li><a href="./Pharmacist/MyProfile.php">View Profile</a></li>
                      <li><a href="./Pharmacist/EditProfile.php">Edit Profile</a></li>
                      <li><a href="./Pharmacist/ChangePassword.php">Change Password</a></li> 
                      </ul>
                    </li>
    ...
    <div class="owl-carousel owl-single px-0">
      <div class="site-blocks-cover overlay" style="background-image: url('./Assets/Templates/Main/images/hero_bg.jpg');">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0"><strong class="text-primary">Pharmacie</strong> Opens 24 Hours</h1>
                <br>
                <br>

                <div class="row justify-content-center mb-5">
                  <div class="col-lg-6 text-center">
                    <p>"Care You Can Count On" – Fast, affordable, and personalized pharmacy services for all your healthcare needs, anytime, anywhere.</p>
                  </div>
                </div>

                <p><a href="./Guest/Login.php" class="btn btn-primary px-5 py-3">LOGIN</a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url('./Assets/Templates/Main/images/hero_bg_2.jpg');">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                ...
                <div class="row justify-content-center mb-5">
                  <div class="col-lg-6 text-center">
                    <p>"Medications Made Easy" – Get access to genuine medicines, quick refills, and expert advice, all at your fingertips.</p>
                  </div>
                </div>
                <p><a href="./Guest/Login.php" class="btn btn-primary px-5 py-3">LOGIN</a></p>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center col-12">
            <h2>Products <strong class="text-primary">Available</strong></h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 block-3 products-wrap">
            <div class="nonloop-block-3 owl-carousel">
              ...
              <div class="text-center item mb-4 item-v2">
                <a href="shop-single.html"> <img src="./Assets/Templates/Main/images/P4.jpeg" alt="Image"></a>
                <h3 class="text-dark"><a href="shop-single.html">Aspirin</a></h3>
                <p class="price"></p>
              </div>
              ...
              <!-- <div class="text-center item mb-4 item-v2">
                <span class="onsale">Sale</span>
                <a href="shop-single.html"> <img src="./Assets/Templates/Main/images/product_03.png" alt="Image"></a>
                <h3 class="text-dark"><a href="shop-single.html">Umcka Cold Care</a></h3>
                <p class="price">$120.00</p>
              </div>

              <div class="text-center item mb-4 item-v2">
                <a href="shop-single.html"> <img src="./Assets/Templates/Main/images/product_01.png" alt="Image"></a>
                <h3 class="text-dark"><a href="shop-single.html">Umcka Cold Care</a></h3>
                <p class="price">$120.00</p>
              </div>
              ...
              <div class="text-center item mb-4 item-v2">
                <span class="onsale">Sale</span>
                <a href="shop-single.html"> <img src="./Assets/Templates/Main/images/product_02.png" alt="Image"></a>
                <h3 class="text-dark"><a href="shop-single.html">Umcka Cold Care</a></h3>
                <p class="price">$120.00</p>
              </div>

              <div class="text-center item mb-4 item-v2">
                <a href="shop-single.html"> <img src="./Assets/Templates/Main/images/product_04.png" alt="Image"></a>
                <h3 class="text-dark"><a href="shop-single.html">Umcka Cold Care</a></h3>
                <p class="price">$120.00</p>
              </div> -->
    ...
    <!-- <div class="site-section bg-image overlay" style="background-image: url('./Assets/Templates/Main/images/hero_bg_2.jpg');">
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-6">
            ...
            <div class="owl-single no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="./Assets/Templates/Main/images/person_4.jpg" alt="Image" class="img-fluid">
                  <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis voluptatem consectetur quam tempore
                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur ducimus. Minus ratione sit quaerat
                    unde.&rdquo;</p>
                </blockquote>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="block-7">
              <h3 class="footer-heading mb-4">About <strong class="text-primary">Pharmacie</strong></h3>
